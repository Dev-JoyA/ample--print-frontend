export const SITE_CONFIG = {
  ...
  description: 'Premium printing services for businesses and individuals. Custom printing, fast delivery, and quality guaranteed.',
...
export const METADATA = {
  ...
  products: {
    ...
    description: 'Explore our wide range of printing products including flyers, business cards, posters, and custom designs.',
  ...
  orderTracking: {
    ...
    description: 'Track the status of your print order in real-time. Enter your order number to get updates.',
...
export const getProductMetadata = (product) => ({
  ...
  description: product.description || `Order ${product.name} from Ample Print Hub. ${product.material || 'High quality'} printing.`,
