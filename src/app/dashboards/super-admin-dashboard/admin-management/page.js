...
const AdminManagementPage = () => {
    ...
    const getStatusBadge = (isApproved) => {
        return isApproved ? (
            <span className="inline-block bg-green-900/50 text-green-400 px-2 py-1 rounded-full text-xs border border-green-700">
                Approved
            </span>
        ) : (
            <span className="inline-block bg-yellow-900/50 text-yellow-400 px-2 py-1 rounded-full text-xs border border-yellow-700">
                Pending
            </span>
        );
    };
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-400">Manage administrators and view their design activity</p>
                            </div>
                                        ...
                                        {admins.length === 0 ? (
                                            ...
                                            admins.map((admin) => (
                                                <tr key={admin.user} className="border-b border-gray-800 hover:bg-slate-800/50">
                                                    ...
                                                    <td className="p-4">
                                                        <span className={`inline-block rounded-full px-2 py-1 text-xs border ${
                                    ...
                                    {designsLoading ? (
                                        ...
                                        <>
                                            <table className="min-w-full">
                                                <thead className="border-b border-gray-800 bg-slate-950">
                                                    <tr>
                                                        <th className="p-4 text-left text-sm font-medium text-gray-400">Design ID</th>
                                                        <th className="p-4 text-left text-sm font-medium text-gray-400">Uploaded By</th>
                                                        ...
                                                        <th className="p-4 text-left text-sm font-medium text-gray-400">Status</th>
                                                        <th className="p-4 text-left text-sm font-medium text-gray-400">Uploaded</th>
                                                        <th className="p-4 text-left text-sm font-medium text-gray-400">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
