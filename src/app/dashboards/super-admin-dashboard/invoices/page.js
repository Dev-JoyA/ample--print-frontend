        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-5">
            ...
            <div 
              ...
              className={`cursor-pointer rounded-lg border p-4 transition hover:bg-slate-800/50 ${
                filter === "PartiallyPaid" ? "border-yellow-500 bg-slate-900" : "border-gray-800 bg-slate-900"
              }`}
            >
                    ...
                    {filteredInvoices.map((invoice) => {
                      ...
                      return (
                        <tr key={invoice._id} className="transition hover:bg-slate-800/30">
                          ...
                          <td className="px-6 py-4">
                            <span className={`inline-block rounded-full px-2 py-1 text-xs font-medium bg-${getStatusColor(invoice.status)}-600/20 text-${getStatusColor(invoice.status)}-400`}>
                              {invoice.status}
                            </span>
                          </td>
                          <td className="px-6 py-4">
