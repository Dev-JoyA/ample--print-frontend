      ...
      <DashboardLayout userRole="super-admin">
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="mb-8">
            <button
              onClick={() =>
                router.push('/dashboards/super-admin-dashboard/orders?filter=needs-invoice')
              }
          ...
          <div
            ref={invoiceRef}
            className="space-y-6 rounded-xl border border-gray-800 bg-slate-900/50 p-6 backdrop-blur-sm"
          >
