  ...
  return (
    <DashboardLayout userRole="admin">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Collection Details */}
        <div className="bg-slate-900 rounded-xl border border-gray-800 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <Link href={`/dashboards/admin-dashboard/collections/${collectionId}/products`}>
            <div className="bg-slate-900 rounded-lg border border-gray-800 p-6 hover:border-red-600 transition cursor-pointer">
              ...
              <p className="text-gray-400">View, edit, or add products to this collection</p>
            </div>
          </Link>

          <Link href={`/dashboards/admin-dashboard/products/create?collectionId=${collectionId}`}>
            <div className="bg-slate-900 rounded-lg border border-gray-800 p-6 hover:border-green-600 transition cursor-pointer">
              <div className="text-4xl mb-4">➕</div>
              <h3 className="text-xl font-bold text-white mb-2">Add New Product</h3>
              <p className="text-gray-400">Create a new product in this collection</p>
            </div>
          </Link>

          <Link href={`/dashboards/admin-dashboard/collections/${collectionId}/edit`}>
            <div className="bg-slate-900 rounded-lg border border-gray-800 p-6 hover:border-blue-600 transition cursor-pointer">
              <div className="text-4xl mb-4">✏️</div>
              <h3 className="text-xl font-bold text-white mb-2">Edit Collection</h3>
              <p className="text-gray-400">Update collection name or settings</p>
            </div>
          </Link>
        </div>
      </div>
