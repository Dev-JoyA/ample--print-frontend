    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-slate-950 text-[#FFFFFF] px-4 sm:px-6 lg:px-8 py-8 flex flex-col">
                <div className="max-w-2xl w-full mx-auto py-6 sm:py-8 flex flex-col gap-6 sm:gap-8">
                    <div>
                    ...
                    <div>
                        <div>
                            <h1 className="font-inter font-[700] text-xl sm:text-2xl leading-tight">Join the elite</h1>
                            <p className="text-gray-300 text-xs sm:text-sm pt-2">Start printing with the highest industry standards.</p>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col">
                                        <label className="font-bold text-xs sm:text-sm" htmlFor="firstName">First Name/Company Name</label>
                                        <input 
                                    ...
                                    <div className="flex flex-col">
                                        <label className="font-bold text-xs sm:text-sm" htmlFor="lastName">Last Name</label>
                                        <input 
                                            className="bg-slate-950 border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-600 text-white text-sm sm:text-base" 
                                            type="text" 
                                            id="lastName" 
                                    ...
                                    <div className="flex flex-col">
                                        <label className="font-bold text-xs sm:text-sm" htmlFor="phoneNumber">Phone Number</label>
                                        <input 
                                            className="bg-slate-950 border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-600 text-white text-sm sm:text-base" 
                                            type="tel" 
                                            id="phoneNumber" 
                                    ...
                                    <div className="flex flex-col">
                                        <label className="font-bold text-xs sm:text-sm" htmlFor="userName">Username</label>
                                        <input 
                                            className="bg-slate-950 border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-600 text-white text-sm sm:text-base" 
                                            type="text" 
                                            id="userName" 
                                    ...
                                    <div className="md:col-span-2 flex flex-col">
                                        <label className="font-bold text-xs sm:text-sm" htmlFor="address">Address</label>
                                        <input 
                                            className="bg-slate-950 border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-600 text-white text-sm sm:text-base" 
                                            id="address" 
                                            name="address" 
                                    ...
                                    <div className="md:col-span-2 flex items-center gap-2 mt-4 w-full">
                                        <input 
                                            ...
                                            disabled={loading}
                                        />
                                        <label htmlFor="terms" className="text-xs sm:text-sm flex-1 text-gray-300">
                        ...
                        <p className="font-carlito text-xs sm:text-sm flex justify-center text-gray-600 mt-4 sm:mt-6">
                            ...
                            <Link href="/auth/sign-in" className="text-[#FF676A] hover:underline ml-1">
                                Sign in
                            </Link>
                        </p>
