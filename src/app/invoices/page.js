        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-lg border border-gray-800 bg-slate-900/30 p-4">
            <p className="flex items-center gap-2 text-sm text-gray-400">
              ...
              <span>
                <span className="font-medium text-white">Invoice Types:</span> Regular invoices are
                for your order items. Shipping invoices (marked with a badge) are for delivery
                costs.
              </span>
            </p>
          </div>
