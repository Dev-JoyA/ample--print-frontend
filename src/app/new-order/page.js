  ...
  const essentialSolutions = [
    {
      ...
      desc: 'Credible, foundational business materials.',
      image: '/images/collection/nylons/1.jpg',
    },
    {
      id: 2,
      name: 'MARKETING PRINTS',
      desc: 'High-impact promotional paper prints.',
      image: '/images/collection/paperbags/bagpp.webp',
    },
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <p className="mb-8 max-w-2xl text-base text-gray-400 sm:text-lg">
              From foundational Brand Essentials to elite Large Format signage. Experience the
              highest standard of industrial printing precision.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {essentialSolutions.map((solution) => (
                <div
                  key={solution.id}
                  className="overflow-hidden rounded-lg border border-dark-lighter bg-slate-900 transition-all hover:border-primary/50"
                >
                  ...
                  <div className="p-4">
                    ...
                    <Link
                      href={`/collections/${solution.id}/products`}
              ...
              {[
                {
                  ...
                  desc: 'Select from our library of premium materials and product types.',
                },
                {
                  step: 2,
                  title: 'Voice Your Needs',
                  desc: 'Record an audio brief or upload assets. Our designers take it from there.',
                },
                {
                  step: 3,
                  title: 'Review & Print',
