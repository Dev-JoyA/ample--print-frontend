...
function PaymentPageContent() {
  ...
  if (loading) {
    return (
      <>
        <SEOHead title="Payment" description="Make payment for your invoice" robots="noindex, nofollow" />
        <DashboardLayout userRole="customer">
          <div className="mx-auto max-w-7xl px-4 py-8">
            <div className="flex min-h-[60vh] items-center justify-center">
              <div className="text-white">Loading payment details...</div>
  ...
  if (!invoice || !order) {
    return (
      <>
        <SEOHead title="Payment - Invoice Not Found" description="The requested invoice could not be found" robots="noindex, nofollow" />
        <DashboardLayout userRole="customer">
          <div className="mx-auto max-w-7xl px-4 py-8">
            <div className="py-16 text-center">
              <p className="text-gray-400">Invoice not found</p>
              <button onClick={() => router.push('/invoices')} className="mt-4 text-red-500 hover:text-red-400">
                Back to Invoices
              </button>
            </div>
          </div>
            ...
            <div className="space-y-6 lg:col-span-2">
              ...
              <div className="rounded-xl border border-gray-800 bg-[#0A0A0A] p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div className={`mb-3 flex h-14 w-14 items-center justify-center rounded-xl sm:h-16 sm:w-16 ${paymentMethod === 'paystack' ? 'bg-[#2D6BFF]/20' : 'bg-gray-800'}`}>
                        <span className="text-2xl sm:text-3xl">💳</span>
                      </div>
                      <h3 className="text-sm font-semibold text-white sm:text-base">Paystack</h3>
                      <p className="mb-2 text-xs text-gray-400 sm:mb-3 sm:text-sm">Card, Bank Transfer, USSD</p>
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div className={`mb-3 flex h-14 w-14 items-center justify-center rounded-xl sm:h-16 sm:w-16 ${paymentMethod === 'bank' ? 'bg-[#2D6BFF]/20' : 'bg-gray-800'}`}>
                        <span className="text-2xl sm:text-3xl">🏦</span>
                      </div>
                      <h3 className="text-sm font-semibold text-white sm:text-base">Bank Transfer</h3>
                      <p className="mb-2 text-xs text-gray-400 sm:mb-3 sm:text-sm">Upload payment receipt</p>
              ...
              {paymentMethod === 'bank' && (
                <div className="rounded-xl border border-gray-800 bg-[#0A0A0A] p-5 sm:p-6">
                  ...
                  <div className="mb-5 grid grid-cols-1 gap-3 sm:mb-6 sm:grid-cols-3 sm:gap-4">
                    <div className="rounded-lg border border-gray-800 bg-[#0F0F0F] p-3 sm:p-4">
                      <p className="text-xs text-gray-400 sm:text-sm">Account Name</p>
                      <p className="text-sm font-medium text-white sm:text-base">{bankAccount?.accountName || 'Not available'}</p>
                    </div>
                    <div className="rounded-lg border border-gray-800 bg-[#0F0F0F] p-3 sm:p-4">
                      <p className="text-xs text-gray-400 sm:text-sm">Account Number</p>
                      <p className="text-sm font-medium text-white sm:text-base">{bankAccount?.accountNumber || 'Not available'}</p>
                    </div>
                    <div className="rounded-lg border border-gray-800 bg-[#0F0F0F] p-3 sm:p-4">
                      <p className="text-xs text-gray-400 sm:text-sm">Bank</p>
                      <p className="text-sm font-medium text-white sm:text-base">{bankAccount?.bankName || 'Not available'}</p>
                    </div>
                  </div>

                  <div>
                    <label className="mb-2 block text-sm font-medium text-gray-300">Upload Payment Receipt</label>
                    <div className="rounded-lg border-2 border-dashed border-gray-800 p-4 text-center transition-colors hover:border-[#2D6BFF]/50 sm:p-6">
                      <input
                        type="file"
                        accept="image/*,.pdf"
              ...
              <div className="rounded-xl border border-gray-800 bg-[#0A0A0A] p-5 sm:p-6">
                <h3 className="mb-1 text-base font-semibold text-white sm:text-lg">Payment Options</h3>
                ...
                <div className="space-y-3">
                  ...
                  {/* Items / Full Payment */}
                  <label className={`flex items-center gap-3 rounded-lg border p-3 transition-colors ${
                    ...
                    {isOptionEnabled('full') && (
                      <span className="ml-auto shrink-0 text-xs font-semibold text-[#2D6BFF]">Selected</span>
                    )}
                  </label>
                  ...
                  <label className={`flex items-center gap-3 rounded-lg border p-3 transition-colors ${
                    ...
                    <div className="flex-1">
                      <span className="text-sm font-medium text-white sm:text-base">
                        {isOptionEnabled('part')
                          ? (depositPaid ? 'Balance Payment' : 'Part Payment')
                          : 'Part Payment'}
                      </span>
                      <p className="text-xs text-gray-400 sm:text-sm">
                        {isOptionEnabled('part')
              ...
              <div className="sticky top-24 rounded-xl border border-gray-800 bg-[#0A0A0A] p-5 sm:p-6">
                    ...
                    <div key={index} className="flex gap-3 rounded-lg border border-gray-800 bg-[#0F0F0F] p-3">
                      <div className="h-12 w-12 flex-shrink-0 overflow-hidden rounded-lg bg-gray-800 sm:h-16 sm:w-16">
                        <Image
                          ...
                          height={64}
                          className="h-full w-full object-cover"
                          onError={(e) => { e.target.src = '/images/dummy-images/image 3.png'; }}
                        />
                      </div>
                      <div className="flex-1">
                        <h4 className="text-xs font-medium text-white sm:text-sm">{item.productName}</h4>
                ...
                <div className="mt-4 rounded-lg bg-[#2D6BFF]/20 p-3 sm:mt-6 sm:p-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <span className="text-xs font-medium text-[#2D6BFF] sm:text-sm">{getAmountToPayLabel()}</span>
                    <span className="text-base font-bold text-[#2D6BFF] sm:text-xl">{formatCurrency(amountToPay)}</span>
                  </div>
                  {paymentType === 'part' && !depositPaid && (
                    <p className="mt-1 text-xs text-gray-400">
                      Remaining after deposit: {formatCurrency(totalAmount - depositAmount)}
