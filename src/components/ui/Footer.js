      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4 md:gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-1 text-xs text-gray-400 sm:space-y-2 sm:text-sm">
              ...
              <p>
                <a href="tel:+2348142534202" className="transition-colors hover:text-blue-500 hover:underline">
                  +2348142534202
                </a>
              </p>
              <p>
                <a href="mailto:amplePrintHub@gmail.com" className="transition-colors hover:text-blue-500 hover:underline">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400 sm:text-sm">
              <li>
                <Link href="/collections/brand-essentials" className="transition-colors hover:text-primary">
                  Business Cards
                </Link>
              </li>
              <li>
                <Link href="/collections/marketing" className="transition-colors hover:text-primary">
                  Flyers & Brochures
                </Link>
              </li>
              <li>
                <Link href="/collections/large-format" className="transition-colors hover:text-primary">
                  Banners & Posters
                </Link>
              </li>
              <li>
        ...
        <div className="mt-6 border-t border-dark-lighter pt-6 sm:mt-8 sm:pt-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="mb-1 text-sm font-semibold text-white sm:text-base">Subscribe to our newsletter</h3>
              <p className="text-xs text-gray-400 sm:text-sm">Get updates on new products and special offers</p>
            </div>
