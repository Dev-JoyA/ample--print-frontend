const StatusBadge = ({ status, type = 'order', className = "" }) => {
  const statusConfig = {
    order: {
      ...
      OrderReceived: { label: 'ORDER RECEIVED', color: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
      FilesUploaded: { label: 'FILES UPLOADED', color: 'bg-purple-500/20 text-purple-400 border-purple-500/30' },
      AwaitingInvoice: { label: 'AWAITING INVOICE', color: 'bg-orange-500/20 text-orange-400 border-orange-500/30' },
      InvoiceSent: { label: 'INVOICE SENT', color: 'bg-indigo-500/20 text-indigo-400 border-indigo-500/30' },
      DesignUploaded: { label: 'DESIGN UPLOADED', color: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
      UnderReview: { label: 'UNDER REVIEW', color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
      Approved: { label: 'APPROVED', color: 'bg-green-500/20 text-green-400 border-green-500/30' },
      AwaitingPartPayment: { label: 'AWAITING PAYMENT', color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
      PartPaymentMade: { label: 'PART PAYMENT', color: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
      InProduction: { label: 'IN PRODUCTION', color: 'bg-purple-500/20 text-purple-400 border-purple-500/30' },
      Completed: { label: 'COMPLETED', color: 'bg-green-500/20 text-green-400 border-green-500/30' },
      AwaitingFinalPayment: { label: 'AWAITING PAYMENT', color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
      FinalPaid: { label: 'PAID', color: 'bg-green-500/20 text-green-400 border-green-500/30' },
      ReadyForShipping: { label: 'READY TO SHIP', color: 'bg-teal-500/20 text-teal-400 border-teal-500/30' },
    ...
    payment: {
      ...
      PartPayment: { label: 'PARTIALLY PAID', color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
    ...
    invoice: {
      ...
      PartiallyPaid: { label: 'PARTIALLY PAID', color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
      Paid: { label: 'PAID', color: 'bg-green-500/20 text-green-400 border-green-500/30' },
