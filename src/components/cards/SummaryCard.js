    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex-1">
          ...
          <p className={`text-base font-bold ${colorClasses[color]} sm:text-lg md:text-xl`}>{value}</p>
        </div>
        <div className={`flex h-10 w-10 items-center justify-center rounded-full ${bgColorClasses[color]} sm:h-12 sm:w-12`}>
