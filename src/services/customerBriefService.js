...
const PATHS = {
  ...
  ADMIN_RESPOND: (orderId, productId) => `${BASE}/admin/orders/${orderId}/products/${productId}/respond`,
  ADMIN_BRIEFS: `${BASE}/admin/briefs`,
  ADMIN_MARK_VIEWED: (briefId) => `${BASE}/admin/briefs/${briefId}/mark-viewed`,
  BY_ORDER_PRODUCT: (orderId, productId) => `${BASE}/briefs/orders/${orderId}/products/${productId}`,
...
//   },
  ...
  getStatus: (orderId, productId) =>
    api.get(PATHS.STATUS(orderId, productId)),
