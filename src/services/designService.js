  ...
  getAll: async (params = {}) => {
    try {
      ...
      if (!api) {
        ...
        return { success: false, data: [], total: 0, page: params.page || 1, limit: params.limit || 10, pages: 0 };
      }
      ...
      if (error.message === "Design not found" || error.status === 400) {
        ...
        return { success: true, data: [], total: 0, page: params.page || 1, limit: params.limit || 10, pages: 0 };
      }
      if (error.status === 404) {
